...
string_opts.info("Please note that there is a limit of 2000 genes for STRING network analysis.")
...
if plot_string:
    _, gene_dict = genePP.genes_used(degs=degs,
                                     useDEG=st.session_state['string_useDEG'],
                                     textgene=st.session_state['string_textgene'])
